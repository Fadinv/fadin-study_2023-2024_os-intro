...
![Работа с file system](image/3.png){#fig:003 width=70%}

Права доступа.

![Примеры изменения прав доступа](image/4.png){#fig:003 width=70%}
...
![Вызов команды mount](image/5.png){#fig:004 width=70%}
...
![Вызов команды cat /etc/fstab, df, fsck /dev/sda1](image/7.png){#fig:005 width=70%}
...
![Часть 2 ЛР. Выполнение инструкций по работе с fs](image/8.png){#fig:006 width=70%}
...
![Часть 3 ЛР. Настройка прав доступа](image/9.png){#fig:007 width=70%}

## Часть 4. Вызов команд по работе с fs с ограничением прав на файлы и папки

Просмотр файла /etc/passwd

![Часть 4 ЛР. Просмотр файла /etc/passwd](image/10.png){#fig:008 width=70%}

Просмотр файла /etc/passwd

Как видно из рисунка ниже, ограничение прав на файлы и папки делает невозможным совершение определенных действий с ними.

![Часть 4 ЛР. Вызов команд по работе с fs с ограничением прав на файлы и папки](image/11.png){#fig:009 width=70%}
...
![Часть 5 ЛР. man mount](image/12.png){#fig:010 width=70%}
...
![Часть 5 ЛР. man fsck](image/13.png){#fig:011 width=70%}
...
![Часть 5 ЛР. man mkfs](image/14.png){#fig:012 width=70%}
...
![Часть 5 ЛР. man kill](image/15.png){#fig:013 width=70%}
...
![Часть 5 ЛР. man kill](image/15.png){#fig:014 width=70%}
