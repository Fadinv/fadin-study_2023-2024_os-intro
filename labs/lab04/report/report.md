...
![Команда pwd](images/1.png){#fig:001 width=70%}

С помощью утилиты cd перехожу в подкаталог tmp корневого каталога.

![Перемещение между директориями](images/2.png){#fig:002 width=70%}

С помощью утилиты ls, пока что без ключей, просматриваю содержимое каталога tmp.

![Просмотр содержимого каталога](images/3.png){#fig:003 width=70%}
...
![Просмотр содержимого каталога](images/4.png){#fig:004 width=70%}

Опция -a покажет скрытые файлы в каталоге.

![Просмотр содержимого каталога](images/5.png){#fig:005 width=70%}
...
![Просмотр содержимого каталога](images/6.png){#fig:006 width=70%}
...
Удаляю директорию newdir с помощью утилиты rm -rf, т.к директория не пустая, я добавляю флаг удалить рекурсивно -r и принудительно -f, чтобы удалились все подкаталоги.

![Удаление директорий](images/11.png){#fig:013 width=70%}
...
![Опция для утилиты](images/12.png){#fig:014 width=70%}
...
![Опция утилиты](images/13.png){#fig:015 width=70%}
...
![Опции команды](images/14.png){#fig:016 width=70%}
...
![Информация о pwd](images/15.png){#fig:017 width=70%}
...
![Информация о mkdir](images/16.png){#fig:018 width=70%}
...
![Информация о rmdir](images/17.png){#fig:019 width=70%}
...
![Информация о rm](images/18.png){#fig:021 width=70%}
...
![Команда history](images/19.png){#fig:022 width=70%}
