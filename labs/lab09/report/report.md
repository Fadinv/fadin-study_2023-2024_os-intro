...
![process_args.sh](image/3.png){#fig:003 width=70%}
...
![process_args.sh](image/4.png){#fig:004 width=70%}
...
![myls.sh](image/5.png){#fig:005 width=70%}

![myls.sh](image/6.png){#fig:006 width=70%}
